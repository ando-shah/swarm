...
namespace Assets.EntityTemplates
{
    public class SwarmGoalEntityTemplate : MonoBehaviour
    {
		...
		private static UInt32 numFish;

        // Template definition for a Swarm Goal entity
		public static SnapshotEntity GenerateGoalSnapshotEntityTemplate(int F)
        {
		...
		public static void PopulateSnapshotWithSwarmGoalEntities(ref Dictionary<EntityId, SnapshotEntity> snapshotEntities, ref int nextAvailableId, int numFish)
		{
			snapshotEntities.Add (new EntityId (nextAvailableId++), GenerateGoalSnapshotEntityTemplate (numFish));
